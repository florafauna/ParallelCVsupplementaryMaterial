...
BmeanTaskLength <- allreduce(TTfit, op="sum")/comm.size
BminTaskLength <- allreduce(TTfit, op="min")
BmaxTaskLength <- allreduce(TTfit, op="max")

save(BmeanTaskLength, BminTaskLength, BmaxTaskLength, file="RData/length.RData")
